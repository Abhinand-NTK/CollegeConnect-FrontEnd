...
//     console.log("This is the error", useSelector(state => state.error))


//     // console.log("This is the formdata i need to send to the backend side",formdata)
...
//         }
//     }
//     // Get the classroom details of teacher

//     const GetClassRoomForTeacher = async (sub_ids) => {
//         try {
...
//     const SetClassForTeacher = async (data) => {
//         try {
//             const response = await StaffUserServices.AssignTeacherToClassRoom(data)
...
//             console.log("Is deleted or not::_---", response)
//         } catch (error) {

//         }
//     }

//     const test = async (sub_ids) => {
//         console.log("The page>>>>>>>>>>>>>>>>>>>>>", sub_ids)
//         console.log("The page>>>>>>>>>>>>>>>>>>>>>", sub_ids)
//         console.log("The page>>>>>>>>>>>>>>>>>>>>>", sub_ids)
//         console.log("The page>>>>>>>>>>>>>>>>>>>>>", sub_ids)
//         try {
//             if (sub_ids.length !=0) {
//                 const response = await StaffUserServices.GetClassRoomsForTeacher(sub_ids)
...
//     useEffect(() => {
//         test(sub_ids)
//         GetClassRoomForTeacher(sub_ids)
//     }, [sub_ids])
...
//                         <div className="mt-28  md:mt-20 w-full mx-auto lg:mt-28 ">
...
//                                 <span className="font-light text-gray-500">{userDetails?.staff_details?.age}</span>
//                             </h1>
//                         </div>
//                         <div className="sm:mt-0 mt-2 border-b pb-6 md:pb-12 flex flex-wrap">
//                             <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 md:mb-0">
//                                 <p className="mt-2 text-gray-500">Phone No: {userDetails?.staff_details?.phone_number}</p>
//                                 <p className="mt-2 text-gray-500">
//                                     Email to:{' '}
//                                     <a className='font-bold' href={`mailto:${userDetails?.staff_details?.email}`}>
...
//                                     <p className='font-bold mb-2 '>Assigned Subjects</p>
//                                     <div className='flex items-start ml-4 md:ml-0'>
//                                         <ul>
...
//                                 <thead>
//                                     <tr>
//                                         <th className="p-2 text-white bg-indigo-950">Available Classrooms</th>
//                                         <th className="p-2 text-white bg-indigo-950">Subjects in the classroom</th>
//                                         <th className="p-2 text-white bg-indigo-950">Semester</th>
//                                         <th className="p-2 text-white bg-indigo-950">Assigned Classrooms</th>
//                                         <th className="p-2 text-white bg-indigo-950">Delete Assigned Classrooms</th>
//                                     </tr>
//                                 </thead>
//                                 <tbody>
//                                     {classrooms &&
...
//                                                 <td className="border p-4">{classItem.name} :- {classItem?.course?.coursename}</td>
//                                                 <td className="border pl-12">
//                                                     {classrooms1[classItem.name]?.Subjects.map((item, subIndex) => (
//                                                         <tr key={subIndex} className='text-center   border'>
//                                                             <td className="border p-6 text-center">{item.name}</td>
//                                                         </tr>
//                                                     ))}
//                                                 </td>
...
//                                                     {classrooms1[classItem.name]?.Subjects.map((item, subIndex) => (
//                                                         <tr key={subIndex} className='text-center   border'>
//                                                             <td className="border p-6 text-center">{item.semseter}</td>
//                                                         </tr>
//                                                     ))}
//                                                 </td>
//                                                 <td className="border p-4">
...
//                                                                     }
//                                                                 }
//                                                                 className="bg-green-500 text-white px-4 py-2 mb-2 rounded-md">
//                                                                 Assign
//                                                             </button>
//                                                         </tr>
//                                                     ))}
...
//                                                                                     sub_id: item.id
//                                                                                 });
//                                                                                 DeleteClassForTeacher(classroomsList[item.name][classItem.name])
//                                                                             }
//                                                                         }
...
//     const SetClassForTeacher = async (data,id) => {
//         try {
...
//     useEffect(() => {
//         test(sub_ids);
//         GetClassRoomForTeacher(sub_ids,id);
//     }, [sub_ids]);
...
const StaffStudentBasicInfo = () => {
    ...
    const deleteClassForTeacher = async (data) => {
        try {
            const response = StaffUserServices.DeleleAssignedClassroomForTeacher(data);
            console.log("Is deleted or not: ", response);
        } catch (error) {
            console.log(error);
        }
    };
