...
//     return (
//         <Layout>
//             <div className=" bg-indigo-950 p-28">
                    ...
                    <div className='ml-20'>
                        <div className="mt-6  md:mt-20">
                            <h1 className="text-2xl md:text-4xl font-medium text-gray-700">
                                Abhinand Ntk, <span className="font-light text-gray-500">26</span>
                            </h1>
                            <p className="font-semibold text-gray-600">Kerala, India</p>
                            <p className=" text-gray-500">Student - N.s.s.College Of Engineering,Akethethara</p>
                        ...
                        <div className="sm:mt-0 mt-2 border-b pb-6 md:pb-12">
                            ...
                            <p className="mt-2 text-gray-500">Phone No :- 9656448465</p>
                            <p className="mt-2 text-gray-500">Email :- abhinandntkm@gmail.com</p>
